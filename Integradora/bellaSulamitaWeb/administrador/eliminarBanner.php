...
if (isset($_GET['aceptar']) == "Aceptar y continuar") {
    $bann = $banner->eliminarBanner($ide);
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h3>Imagen:</h3><br><img src="../<?php echo $bann["imagen"] ?> "width="200">
                            </div>
                            <div class="col-md-6">
                                <form method="GET" action="eliminarBanner.php?id=<?php echo $ide ?>" enctype="multipart/form-data">
                                    <h3>Titulo:</h3><h5><?php echo $bann["nombre"] ?></h5><hr>
                                    <h3>Descripción:</h3><p><?php echo $bann["description"] ?></p><hr>
